...
struct Adjacency_list
{
    ...
    int* outgoings;
    int* ingoings;
    struct Integer* ihead;
    struct Integer* itail;
    struct Integer* ohead;
    struct Integer* otail;
    int outgoingnum;
    int ingoingnum;
	int temp_label;
	char allocated;
...
{   
    ...
    struct Integer ignore_edge_source;
    struct Integer ignore_edge_dest;
    int ignore_edge_size;
    char *retrain_tag;
...
int  algorithm_initialization(char*);
...
void init_adjacent(char*);
void init_network(char*);
void calculate_time_cost(const char*,double);
void printOUtandIn();
void print_graph();
